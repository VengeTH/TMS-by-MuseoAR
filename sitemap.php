...
$pages = [
    ...
    ["loc" => "/user/register", "priority" => "0.9", "changefreq" => "monthly"],
    ["loc" => "/pages/about", "priority" => "0.7", "changefreq" => "monthly"],
    ["loc" => "/pages/contact", "priority" => "0.8", "changefreq" => "monthly"],
    ["loc" => "/termsAndConditions", "priority" => "0.3", "changefreq" => "yearly"],
];
