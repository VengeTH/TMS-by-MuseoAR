...
!(function (e, t) {
				...
				(function (e, t, n) {
					...
					de(o, "confirm", n),
						...
						(function (e, t, n, o) {
							...
							o.denyButtonColor &&
								((t.style.backgroundColor = o.denyButtonColor), z(t, r["default-outline"]));
							o.cancelButtonColor &&
	...
	const ke = (e, t) => {
		...
		Ie = (e, t) => {
			...
			if (o.length)
				return (
					(e += t) === o.length ? (e = 0) : -1 === e && (e = o.length - 1), void o[e].focus()
				);
	...
	const ot = (e) => {
		...
		st = (e, t, n) => {
			...
			"function" == typeof n.willClose && n.willClose(t),
				...
				r ? rt(e, t, s, n.returnFocus, n.didClose) : Qe(e, s, n.returnFocus, n.didClose);
		},
		rt = (e, t, n, i, s) => {
		...
		ct = (e, t) => {
			...
			n &&
				...
				Z(n),
				t &&
					(J(t), o.setAttribute("data-button-to-replace", t.className), n.insertBefore(o, t)),
				z([e, n], r.loading));
		},
		ut = (e) => (e.checked ? 1 : 0),
